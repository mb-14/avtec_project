...
//$seconds_P = 0;
$SumCoolantUnit = '00:00:00';
//$seconds_C = 0;
$SumControlUnit = '00:00:00';
//$seconds_Cl = 0;
while ($row = $result->fetchArray(SQLITE3_ASSOC)) {
   ...
   switch($data[$i]['failed_unit']){
     ...
     break;
      case "Coolant Unit":
     $SumCoolantUnit=sum_the_time($SumCoolantUnit,$data[$i]['duration']);
     break;
      case "Control Unit":
     $SumControlUnit=sum_the_time($SumControlUnit,$data[$i]['duration']);
     break;
   }
